    ...
    <section className="relative overflow-hidden bg-black">
      ...
      <div className="relative mx-auto grid max-w-7xl gap-16 px-6 py-20 lg:grid-cols-2 lg:items-center lg:px-16 lg:py-28">
        ...
        <ScrollReveal variant="fade-right">
          <span className="inline-flex items-center gap-2.5 rounded-full border border-[#C9943A]/25 bg-[#C9943A]/10 px-4 py-1.5 text-xs font-bold text-[#C9943A]">
            <span className="h-1.5 w-1.5 rounded-full bg-[#C9943A]" />
            Nigeria&apos;s Premier Automotive Platform
          </span>

          <h1 className="mt-6 text-5xl font-black leading-[1.06] tracking-[-3px] text-white sm:text-[76px]">
            Drive{" "}
            <span
              className="text-transparent"
              style={{
                WebkitTextStroke: "1px rgba(201,148,58,0.7)",
              }}
            >
              Bold.
            </span>
            <br />
            Buy{" "}
            <span className="text-[#C9943A]">Secured.</span>
            <br />
            Own Smart.
          </h1>
        ...
        >
          ...
          <div className="absolute -top-16 left-2 z-20 flex items-center gap-2.5 rounded-2xl border border-white/8 bg-black/80 px-4 py-3 shadow-[0_8px_32px_rgba(0,0,0,0.6)] backdrop-blur-md sm:-left-8">
          ...
          <div className="relative overflow-hidden rounded-3xl border border-white/8 shadow-[0_32px_64px_rgba(0,0,0,0.8)]">
            ...
            <div className="absolute inset-x-0 top-0 flex items-center justify-between p-5">
              <span className="rounded-md bg-black/40 px-2.5 py-1 text-[12px] font-bold uppercase tracking-wide text-white/50 backdrop-blur-sm border border-white/10">
                Featured Vehicle
              </span>
          ...
          {/* New this week badge */}
          <div className="absolute -left-4 top-1/3 z-20 rounded-2xl border border-white/8 bg-black/80 px-4 py-3 backdrop-blur-md shadow-[0_8px_24px_rgba(0,0,0,0.5)] sm:-left-16">
            <p className="text-[11px] text-white/40">New This Week</p>
            <p className="text-[28px] font-black text-[#C9943A]">+24</p>
          </div>

          {/* Response time badge */}
          <div className="absolute -bottom-10 -right-2 z-20 max-w-52 rounded-2xl border border-white/8 bg-black/80 px-3 py-3 backdrop-blur-md shadow-[0_8px_24px_rgba(0,0,0,0.5)] sm:-right-4">
